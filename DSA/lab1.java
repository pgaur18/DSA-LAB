...
class Train
{
	...
	public void Display(
																				System.out.println(" Name : " + this.getName());
																																											System.out.println(" Start Station : " + this.getStartStation()																																												System.out.println(" End Station : " + this.getEndStation());
																																															System.out.println(" No. Of Days : " + this.getNoOfDays());
																																																	System.out.println();
																																																					...
																																																					{
																																																						private Train data[];
																																																							private int top;		// Index of top most element in stack
																																																																												...
																																																																												if( top == -1 )
																																																																														{
																																																																																	return true;
																																																																																							...
																																																																																							return false;
																																																																																												...
																																																																																												public int size()
																																																																																													{
																																																																																															return top+1;	// Initially top = -1 and size will be 0;
																																																																																																}
																																																																																																	
																																																																																																		public Train top() throws StackEmptyException
																																																																																																			{
																																																																																																					if( size() == 0 )
																																																																																																							{
																																																																																																										// StackEmptyException
